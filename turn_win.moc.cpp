/****************************************************************************
** Meta object code from reading C++ file 'turn_win.hpp'
**
...
#include <memory>
#include "GUI/turn_win.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'turn_win.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 9), // "turnEnded"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 22), // "onRegularActionClicked"
QT_MOC_LITERAL(4, 45, 22), // "onSpecialActionClicked"
QT_MOC_LITERAL(5, 68, 15) // "onInvestClicked"

    },
    "TurnWindow\0turnEnded\0\0onRegularActionClicked\0"
    "onSpecialActionClicked\0onInvestClicked"
};
...
void TurnWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onRegularActionClicked(); break;
        case 2: _t->onSpecialActionClicked(); break;
        case 3: _t->onInvestClicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TurnWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurnWindow::turnEnded)) {
                *result = 0;
                return;
            }
        }
